...
export default function SettingsPanel({ settings, onSettingsChange, onClose, initialSection }) {
  ...
  function RssFeedsSection() {
    ...
    async function addFeed() {
      ...
      const updated = [...feeds, { name, url, category: feedCat }];
      save({ rssFeeds: updated });
      setFeedName('');
      setFeedUrl('');
    }
    ...
    return (
      <Section title="RSS Feeds" sectionKey="feeds" activeSection={initialSection}>
        ...
        <button className="sp-btn sp-btn-secondary sp-btn-small" onClick={resetFeeds}>Reset to Defaults</button>
      </Section>
    );
  }
  ...
  function QuickLinksSection() {
    ...
    return (
      <Section title="Quick Links" sectionKey="quicklinks" activeSection={initialSection}>
        ...
        <button className="sp-btn sp-btn-secondary sp-btn-small" onClick={resetLinks}>Reset to Defaults</button>
      </Section>
    );
  }
